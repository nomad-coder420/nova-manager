...
def main():
    ...
    parser.add_argument('--burst', action='store_true', help='Run in burst mode (quit after processing all jobs)')
    parser.add_argument('--queue', default='default', help='Queue name to process (default: "default")')
