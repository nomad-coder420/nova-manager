...
Revision ID: a4e74831560c
Revises: 
Create Date: 2025-07-21 00:39:09.587130
...
def upgrade() -> None:
    ...
    op.create_table('experience_variants',
    sa.Column('name', sa.String(), nullable=False),
    sa.Column('description', sa.String(), nullable=False),
    sa.Column('experience_id', sa.UUID(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['experience_id'], ['experiences.pid'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name', 'experience_id', name='uq_experience_variants_name_exp')
    )
    op.create_index('idx_experience_variants_experience_id', 'experience_variants', ['experience_id'], unique=False)
    op.create_index(op.f('ix_experience_variants_id'), 'experience_variants', ['id'], unique=True)
    op.create_index(op.f('ix_experience_variants_pid'), 'experience_variants', ['pid'], unique=True)
    ...
    sa.ForeignKeyConstraint(['experience_id'], ['experiences.pid'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('experience_id', 'priority', name='uq_personalisations_exp_prio'),
    ...
    op.create_index('idx_personalisations_priority', 'personalisations', ['priority'], unique=False)
    ...
    sa.Column('experience_variant_id', sa.UUID(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['experience_variant_id'], ['experience_variants.pid'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('idx_experience_feature_variants_experience_feature_id', 'experience_feature_variants', ['experience_feature_id'], unique=False)
    ...
    op.create_table('personalisation_experience_variants',
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('personalisation_id', 'experience_variant_id', name='uq_personalisation_experience_variants_per_exp_var')
    )
    op.create_index(op.f('ix_personalisation_experience_variants_experience_variant_id'), 'personalisation_experience_variants', ['experience_variant_id'], unique=False)
    op.create_index(op.f('ix_personalisation_experience_variants_id'), 'personalisation_experience_variants', ['id'], unique=True)
    op.create_index(op.f('ix_personalisation_experience_variants_personalisation_id'), 'personalisation_experience_variants', ['personalisation_id'], unique=False)
    op.create_index(op.f('ix_personalisation_experience_variants_pid'), 'personalisation_experience_variants', ['pid'], unique=True)
    ...
    op.create_table('personalisation_segment_rules',
    sa.Column('personalisation_id', sa.UUID(), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('personalisation_id', 'segment_id', name='uq_personalisation_segment_rules_tr_seg')
    )
    op.create_index(op.f('ix_personalisation_segment_rules_id'), 'personalisation_segment_rules', ['id'], unique=True)
    op.create_index(op.f('ix_personalisation_segment_rules_personalisation_id'), 'personalisation_segment_rules', ['personalisation_id'], unique=False)
    op.create_index(op.f('ix_personalisation_segment_rules_pid'), 'personalisation_segment_rules', ['pid'], unique=True)
    op.create_index(op.f('ix_personalisation_segment_rules_segment_id'), 'personalisation_segment_rules', ['segment_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_personalisation_segment_rules_segment_id'), table_name='personalisation_segment_rules')
    op.drop_index(op.f('ix_personalisation_segment_rules_pid'), table_name='personalisation_segment_rules')
    op.drop_index(op.f('ix_personalisation_segment_rules_personalisation_id'), table_name='personalisation_segment_rules')
    op.drop_index(op.f('ix_personalisation_segment_rules_id'), table_name='personalisation_segment_rules')
    op.drop_table('personalisation_segment_rules')
    ...
    op.drop_index(op.f('ix_personalisation_experience_variants_pid'), table_name='personalisation_experience_variants')
    op.drop_index(op.f('ix_personalisation_experience_variants_personalisation_id'), table_name='personalisation_experience_variants')
    op.drop_index(op.f('ix_personalisation_experience_variants_id'), table_name='personalisation_experience_variants')
    op.drop_index(op.f('ix_personalisation_experience_variants_experience_variant_id'), table_name='personalisation_experience_variants')
    op.drop_table('personalisation_experience_variants')
    ...
    op.drop_index('idx_experience_feature_variants_experience_feature_id', table_name='experience_feature_variants')
    ...
    op.drop_index('idx_personalisations_priority', table_name='personalisations')
    op.drop_index('idx_personalisations_experience_id', table_name='personalisations')
    op.drop_table('personalisations')
    op.drop_index(op.f('ix_experience_variants_pid'), table_name='experience_variants')
    op.drop_index(op.f('ix_experience_variants_id'), table_name='experience_variants')
    op.drop_index('idx_experience_variants_experience_id', table_name='experience_variants')
